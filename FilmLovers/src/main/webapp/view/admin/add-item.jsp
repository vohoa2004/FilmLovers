...
<html lang="en">
    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="/film-lovers/view/user/contribute/addNewFilm/css/bootstrap-reboot.min.css">
        <link rel="stylesheet" href="/film-lovers/view/user/contribute/addNewFilm/css/bootstrap-grid.min.css">
        <link rel="stylesheet" href="/film-lovers/view/user/contribute/addNewFilm/css/magnific-popup.css">
        <link rel="stylesheet" href="/film-lovers/view/user/contribute/addNewFilm/css/select2.min.css">
        <link rel="stylesheet" href="/film-lovers/view/user/contribute/addNewFilm/css/admin.css">
        ...
        <title>Admin - Add New Film</title>
        ...
        <header class="header">
            <div class="header__content">
                ...
                <a href="#" class="header__logo">
                    <img src="/film-lovers/view/user/contribute/addNewFilm/img/logo.svg" alt="">
                </a>
                <!-- end header logo -->
        ...
        <div class="sidebar">
            ...
            <div class="sidebar__user">
                <div class="sidebar__user-img">
                    <a href="#">
                        <img src="/film-lovers/view/user/contribute/addNewFilm/img/user.svg" alt="">
                    </a>
                </div>
            ...
            <li class="sidebar__nav-item">
                <a class="sidebar__nav-link collapsed" data-toggle="collapse" href="#collapseMenu" role="button" aria-expanded="false" aria-controls="collapseMenu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,5.5H12.72l-.32-1a3,3,0,0,0-2.84-2H5a3,3,0,0,0-3,3v13a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V8.5A3,3,0,0,0,19,5.5Zm1,13a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V5.5a1,1,0,0,1,1-1H9.56a1,1,0,0,1,.95.68l.54,1.64A1,1,0,0,0,12,7.5h7a1,1,0,0,1,1,1Z"></path></svg> <span>Movie Database</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"></path></svg></a>
            ...
            <li class="sidebar__nav-item">  <!-- user -->
                <a href="#" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12.3,12.22A4.92,4.92,0,0,0,14,8.5a5,5,0,0,0-10,0,4.92,4.92,0,0,0,1.7,3.72A8,8,0,0,0,1,19.5a1,1,0,0,0,2,0,6,6,0,0,1,12,0,1,1,0,0,0,2,0A8,8,0,0,0,12.3,12.22ZM9,11.5a3,3,0,1,1,3-3A3,3,0,0,1,9,11.5Zm9.74.32A5,5,0,0,0,15,3.5a1,1,0,0,0,0,2,3,3,0,0,1,3,3,3,3,0,0,1-1.5,2.59,1,1,0,0,0-.5.84,1,1,0,0,0,.45.86l.39.26.13.07a7,7,0,0,1,4,6.38,1,1,0,0,0,2,0A9,9,0,0,0,18.74,11.82Z"/></svg> <span>Users</span></a>
            </li>

            <!-- Review collapse -->	
            <li class="sidebar__nav-item">
                <a class="sidebar__nav-link collapsed" data-toggle="collapse" href="#ReviewCollapseMenu" role="button" 
                   aria-expanded="false" aria-controls="collapseMenu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,5.5H12.72l-.32-1a3,3,0,0,0-2.84-2H5a3,3,0,0,0-3,3v13a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V8.5A3,3,0,0,0,19,5.5Zm1,13a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V5.5a1,1,0,0,1,1-1H9.56a1,1,0,0,1,.95.68l.54,1.64A1,1,0,0,0,12,7.5h7a1,1,0,0,1,1,1Z"></path></svg> <span>Review</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"></path></svg></a>
            ...
            <li class="sidebar__nav-item">  <!-- Link "Back to Film Lover" -->
                <a href="/film-lovers/film" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,11H9.41l3.3-3.29a1,1,0,1,0-1.42-1.42l-5,5a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l5,5a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L9.41,13H17a1,1,0,0,0,0-2Z"/></svg> <span>Back to Film Lovers</span></a>
            </li>
        </ul>
        <!-- end sidebar nav -->
    ...
    <main class="main">
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- form -->
                <div class="col-12">
                    <form action="/film-lovers/admin/film?action=add" class="form" method="POST">
                        <div class="row">   
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-12">
                                        ...
                                        <div class="form__img">
                                            ...
                                            <input type="file" accept="image/*" id="fileButton" style="display: none;">
                            ...
                            <div class="col-12 col-md-7 form__content">   
                                <div class="row">
                                    ...
                                    <div class="col-12">  <!-- country -->
                                        <div class="form__group">
                                            <select class="js-example-basic-multiple" id="country" name="country" multiple="multiple" required>
                                    ...
                                    <div class="col-6">   <!-- release year -->
                                        <div class="form__group releaseDate">
                                            ...
                                            <input type="text" class="form__input" id="release_year" name="release_year" pattern="(19|20)\d{2}" title="Please enter a valid year (1900-2100)" required>
                                        </div>
                                    </div>
                                    <div class="col-6">   <!-- release month -->
                                        <div class="form__group releaseDate">
                                            <label for="release_month">Month</label>
                                            <input type="text" class="form__input" id="release_month" name="release_month" pattern="0?[1-9]|1[0-2]" title="Please enter a valid month (1-12)" required>
                                        </div>
                                    </div>

                                    <div class="col-12">   <!-- Cover/Photo link -->
                                        <div class="form__group form__group--link">
                                            <input type="text" name="cover_url" class="form__input" placeholder="Cover URL">
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 film_detailed_information">
                                ...
                                <div class="row content">
                                    <div class="col-6"> 
<!--                                        <div class="form__group"> 
                                            <select class="js-example-basic-multiple" id="genres" name="genres" multiple="multiple">
                                        ...
                                        <div class="form__group"> <!-- duration/length -->
                                            <input type="text" name="runtime" class="form__input" placeholder="Duration (minutes)" pattern="[1-9]\d*" title="Please enter a positive integer">

                                        </div>

                                        <div class="form__group"> <!-- language -->
                                            <select class="js-example-basic-multiple" id="language" name="language" multiple="multiple">
                                                ...
                                                <option value="Low German Low Saxon German">Low German Low Saxon German</option>
                                                ...
                                                <option value="Occitan (post 1500) Proven̤al">Occitan (post 1500) Proven̤al</option>
                                                ...
                                                <option value="z"> Reserved for local use">z"> Reserved for local use</option>
                                                ...
                                                <option value="South American Indian (Other)">South American Indian (Other)</option>
                                        ...
                                        <div class="form__group"> <!-- status -->
                                            <select class="js-example-basic-multiple" id="status" name="release_status">
                                    ...
                                    <div class="col-6"> 
                                        <div class="form__group">   <!-- storyline box -->
                                            <textarea id="text" name="story_line" class="form__textarea" placeholder="Storyline"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/jquery-3.5.1.min.js"></script>
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/bootstrap.bundle.min.js"></script>
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/jquery.magnific-popup.min.js"></script>
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/smooth-scrollbar.js"></script>
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/select2.min.js"></script>
    <script src="/film-lovers/view/user/contribute/addNewFilm/js/admin.js"></script>
</body>

...
<body>
	<!-- sign in -->
	<div class="sign section--bg" data-bg="/film-lovers/view/admin/img/bg.jpg">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- authorization form -->
						<form action="/film-lovers/login-admin" class="sign__form" method="POST">
							<a href="#" class="sign__logo">
                                <p>Film Lovers</p>
							</a>

							<div class="sign__group">
								<input type="text" name="txtUsername" class="sign__input" placeholder="Username">
							</div>

							<div class="sign__group">
								<input type="password" name="txtPassword" class="sign__input" placeholder="Password">
							</div>

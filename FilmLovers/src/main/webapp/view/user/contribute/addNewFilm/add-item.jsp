                            ...
                            <div class="col-12 col-md-7 form__content">   
                                <div class="row">
                                    ...
                                    <div class="col-12">  <!-- country -->
                                        <div class="form__group">
                                            <select class="js-example-basic-multiple" id="country" name="country" required>
                                    ...
                                    <div class="col-12">   <!-- Cover/Photo link -->
                                        <div class="form__group form__group--link">
                                            <input type="text" name="cover_url" class="form__input" placeholder="Cover URL" pattern="(http(s?):)([/|.|\w|\s|-])*\.(?:jpg|gif|png)">
                                        </div>
                                    </div>
                                ...
                                <div class="row content">
                                    <div class="col-6"> 
                                        ...
                                        <div class="form__group"> <!-- language -->
                                            <select class="js-example-basic-multiple" id="language" name="language">

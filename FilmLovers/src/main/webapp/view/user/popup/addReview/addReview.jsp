...
<html lang="en">
    <head>
        ...
        <script src="https://kit.fontawesome.com/9f5ff76fc6.js" crossorigin="anonymous"></script>
    </head>
    <body>
            ...
            <form action="review?action=update-review" method="POST">
                <div class="ur_rating_container">
                    ...
                    <div class="star_rating_rv" >
                        ...
                        <div class="num_rating"><input type="text" value="<%= review.getScore()%>" name="score" id="score" class="num_rating" style="width:30px; border:none;text-align: right" readonly> /10</div>
                    </div>
                </div>

<%@page import="filmlovers.model.Account.AccountDTO" %>
    ...
    <body>
        ...
        <% AccountDTO user=(AccountDTO) session.getAttribute("authentication"); if (user==null) { AccountDTO
            createAccount=(AccountDTO) request.getAttribute("account"); pageContext.setAttribute("account",
            createAccount); } else { pageContext.setAttribute("account", user); } %>
            <div class="container">
                            ...
                            <div class="edit_left">
                                <div class="edit_user_id">
                                    <div>
                                        ...
                                        <input type="text" name="txtEmail" value="${account.email}" class="user_name"
                                ...
                                <div class="edit_user_id">
                                    <div>
                                        ...
                                        <input type="text" name="txtUsername" value="${account.username}"
                                            class="user_name" style="background: none; border:none" readonly>
                                ...
                                <div class="edit_user_id flex">
                                    <div>
                                        ...
                                        <input type="text" name="txtFirstName" value="${account.firstName}"
                                            class="user_name" style="border:none;width: 60%">
